import 'package:applus_market/ui/pages/chat/chat_list_page_view_model.dart';
...
class _ChatListPageState extends State<ChatListPage> {
  ChatListPageViewModel chatListPageViewModel = ChatListPageViewModel();
  ...
  List<ChatRoomCard> getFilteredChatList(int tabIndex) {
    switch (tabIndex) {
      case 0: // 전체
        return chatListPageViewModel.chatCards;
      case 1: // 판매
        return chatListPageViewModel.chatCards
